...
I wanted to invest in index funds without the headache of constantly checking charts. I built this app to notify me when it’s time to buy, and the best part is it only costs about $1.50 a month on a t2.micro to run. All the code is right here!
